    ...
    <section id='about' className={classes.section}>
      ...
      <div className='container'>
        ...
        <article className='content'>
          ...
          <p>
            Early in life, Ryan Gasparini had a dream to design automobiles. As
            a child he made various drawings of cars and trucks on napkins,
          ...
          <p>
            ...
            though, when it came to computer programming, he was a natural. It
            was ultimately a C programming class that influenced him to change
            his career path.
          </p>
          ...
          <p>
            ...
            use his love of the Web with his knowledge of C to make the Internet
            a better place.
          </p>
          ...
          <p>
            ...
            random guy named Ryan can learn these skills, he has separated
            himself from the rest by merging what he has learned with his gifts
            of good taste, empathy, and the pursuit of simplicity.
          </p>
        </article>
      </div>
    </section>
